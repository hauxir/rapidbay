...
"object" == typeof navigator && function (e, t) {
  ...
  const Se = [[1, 1], [4, 3], [3, 4], [5, 4], [4, 5], [3, 2], [2, 3], [16, 10], [10, 16], [16, 9], [9, 16], [21, 9], [9, 21], [32, 9], [9, 32]].reduce((e, [t, i]) => ({ ...e,
    [t / i]: [t, i]
  }), {});
  ...
  const Ue = {
    ...
    bindMenuItemShortcuts(e, t) {
      fe.call(this, e, "keydown keyup", i => {
        ...
        if (!s && [32, 39].includes(i.which)) Ue.showMenuPanel.call(this, t, !0);else {
          let t;
  ...
  class it {
    constructor(t) {
      e(this, "onChange", () => {
        ...
        if (this.enabled) if (Y.isIos && this.player.config.fullscreen.iosNative) this.target.webkitExitFullscreen(), ke(this.player.play());else if (!it.native || this.forceFallback) this.toggleFallback(!1);else if (this.prefix) {
          if (!W(this.prefix)) {
